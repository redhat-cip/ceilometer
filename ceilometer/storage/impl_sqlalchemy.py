...
from ceilometer.collector.storage import models as collector_api_models
...
class Connection(alarm_storage.Connection,
    ...
    def get_resources(self, user=None, project=None, source=None,
        ...
        """Return an iterable of collector_api_models.Resource instances
        ...
        for res_id in res_q.all():
            ...
            sample = max_q.first()
            if sample:
                yield collector_api_models.Resource(
    ...
    def get_meters(self, user=None, project=None, resource=None, source=None,
        ...
        """Return an iterable of collector_api_models.Meter instances
        ...
        for sample in query_sample.all():
            yield collector_api_models.Meter(
    ...
    def _retrieve_samples(self, query):
        ...
        for s in samples:
            ...
            yield collector_api_models.Sample(
    ...
    def get_samples(self, sample_filter, limit=None):
        """Return an iterable of collector_api_models.Samples.
    ...
    def _stats_result_to_model(result, period, period_start,
        ...
        return collector_api_models.Statistics(**stats_args)

    def get_meter_statistics(self, sample_filter, period=None, groupby=None,
                             aggregate=None):
        """Return an iterable of collector_api_models.Statistics instances containing
    ...
    def record_events(self, event_models):
        ...
        for event_model in event_models:
            ...
            try:
                ...
                problem_events.append((event_api_models.Event.DUPLICATE,
                                       event_model))
            except Exception as e:
                LOG.exception(_('Failed to record event: %s') % e)
                problem_events.append((event_api_models.Event.UNKNOWN_PROBLEM,
                                       event_model))
            events.append(event)
        ...
        with session.begin():
            ...
            if event_filter.traits_filter:
                ...
                for (id, generated, message_id, desc) in query.all():
                    event_models_dict[id] = event_api_models.Event(message_id,
                                                                   desc,
                                                                   generated,
                                                                   [])
    ...
    def get_traits(self, event_type, trait_type=None):
        ...
        with session.begin():
            ...
            for trait in query.all():
                ...
                yield event_api_models.Trait(name=type.desc,
