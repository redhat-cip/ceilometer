...
from mock import patch  # FIXME(sileht): FunctionalTest with that
...
class TestAlarms(FunctionalTest):
    ...
    def test_post_alarm(self):
        ...
        with patch('ceilometer.openstack.common.rpc.cast'):
            ...
            #FIXME(sileht): wsme should return status=201
        alarms = list(self.alarm_conn.alarm_list())
    ...
    def test_put_alarm(self):
        ...
        with patch('ceilometer.openstack.common.rpc.cast'):
            ...
            #FIXME(sileht): wsme should return status=204
    ...
    def test_delete_alarm(self):
        with patch('ceilometer.openstack.common.rpc.cast'):
            ...
            #FIXME(sileht): wsme should return status=200
        alarms = list(self.alarm_conn.alarm_list())
